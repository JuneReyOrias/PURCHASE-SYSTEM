                ...
                <div class="col-md-4 col-xs-12">
                    <div class="third">
                        ...
                        <ul>
                          ...
                          <li><i class="far fa-envelope"></i> joeyjulian@wmsu.edu.ph</li>
                            <li><i class="far fa-envelope"></i> universitypress@wmsu.edu.ph</li>


                          <li><i class="fas fa-map-marker-alt"></i> Normal Rd, Baliwasan, Zamboanga City </li>
                        </ul>
                    </div>
                </div>
            </div>
